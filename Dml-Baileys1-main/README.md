...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-blue?style=for-the-badge&logo=github)](https://github.com/MLILA05/Dml-Baileys1)
...
"dependencies": {
    "@whiskeysockets/baileys": "github:DAUDY17/Dml-Baileys1.git"
}
```
...
```bash
# Install main branch
npm install https://github.com/MLILA05/Dml-Baileys1.git
```
...
git clone https://github.com/MLILA05/Dml-Baileys1.git
cd your-project
...
# or from GitHub
yarn add https://github.com/MLILA05/Dml-Baileys1.git
```
...
╰━━━━━━━━━━━━━━━━━━━━━━╯`;
    ...
    try {
      ...
      const defaultCaption = `Group status Posted By DML-MD✅\n\nJOIN\nhttps://chat.whatsapp.com/HflwxRda15o0kRMJwsggcD?mode=wwt`;
